using UnityEngine;
/// <summary>
/// Class NetworkMessage, to send messages on sockets.
/// </summary>
[System.Serializable]
public class NetworkMessage
{
    ...
    public NetworkMessage(string messageType, string messageContent)
    {
        this.messageType = messageType;
    ...
    /// </summary>
    /// <returns>JSON string with the converted message</returns>
